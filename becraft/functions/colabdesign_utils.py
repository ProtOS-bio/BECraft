...
from colabdesign.af.loss import get_ptm, get_iptmenergy, mask_loss, get_dgram_bins, _get_con_loss
...
def add_i_ptm_energy_loss(self, weight=0.1, tm_lambda=1):
    ...
    self.opt["weights"]["i_ptm_energy"] = weight
...
def plot_trajectory(af_model, design_name, design_paths):
    metrics_to_plot = ['loss', 'plddt', 'ptm', 'i_ptm', 'i_ptm_energy', 'con', 'i_con', 'pae', 'i_pae', 'rg', 'mpnn']
